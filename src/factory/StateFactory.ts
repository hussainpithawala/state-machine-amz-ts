...
import { ChoiceState, ChoiceRule, ChoiceStateConfig } from '../states/ChoiceState';
...
export class StateFactory {
    ...
    private createTaskState(name: string, data: StateData): BaseState {
        ...
        const config: TaskStateConfig = {
            ...
            resultSelector: data.ResultSelector as Record<string, unknown> | undefined,
        };
    ...
    private createChoiceState(name: string, data: StateData): BaseState {
        const parseRule = (ruleData: StateData): ChoiceRule => {
            const rule = new ChoiceRule({
                ...
                stringLessThanEquals: ruleData.StringLessThanEquals as string | undefined,
                stringGreaterThanEquals: ruleData.StringGreaterThanEquals as string | undefined,
                ...
                numericLessThanEquals: ruleData.NumericLessThanEquals as number | undefined,
                numericGreaterThanEquals: ruleData.NumericGreaterThanEquals as number | undefined,
                ...
                timestampGreaterThan: ruleData.TimestampGreaterThan as string | undefined,
                timestampLessThanEquals: ruleData.TimestampLessThanEquals as string | undefined,
                timestampGreaterThanEquals: ruleData.TimestampGreaterThanEquals as string | undefined,
            ...
            if (ruleData.Not && typeof ruleData.Not === 'object' && ruleData.Not !== null) {
