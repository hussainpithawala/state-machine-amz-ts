...
export class Execution {
     ...
     */
    public static newContext(name: string, startAt: string, inputData: unknown): Execution {
     ...
     */
    public static create(id: string | undefined, name: string, inputData: unknown): Execution {
        return new Execution({
     ...
     */
    public addStateHistory(stateName: string, inputData: unknown, output: unknown): void {
        this.history.push(
            new StateHistory({
                stateName,
                status: "SUCCEEDED",
    ...
    public isComplete(): boolean {
        return ["SUCCEEDED", "FAILED", "TIMED_OUT", "ABORTED"].includes(this.status);
    }
