...
export class PostgresRepository implements Repository {
  ...
  async updateExecution(_partial: Partial<Execution> & { id: string }): Promise<void> {
    throw new Error('PostgresRepository not yet implemented')
  }
  ...
  async saveStateHistory(_history: StateHistory): Promise<void> {
    throw new Error('PostgresRepository not yet implemented')
  }

  async getStateHistory(_executionId: string): Promise<StateHistory[]> {
    throw new Error('PostgresRepository not yet implemented')
  }
}
